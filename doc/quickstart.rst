...
At this point, my-restx remains 100% compatible with Flask-RESTPlus' API.
All you need to do is update your requirements to use my-restx instead of
...
A minimal my-restx API looks like this:
...
Resourceful Routing
-------------------
The main building block provided by my-restx are resources.
...
my-restx understands multiple kinds of return values from view methods.
...
my-restx also support setting the response code and response headers using multiple return values,
as shown below:
...
.. note ::
    ...
    my-restx will return a 404 error message with suggestions of other
...
my-restx has built-in support for request data validation
...
my-restx will respond with a 400 Bad Request and a response highlighting the error.
...
To solve this problem, my-restx provides the :mod:`fields` module and the
