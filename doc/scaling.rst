...
The :ref:`quickstart` section is great for getting started with your first my-restx app,
so if you're new to my-restx you'd be better off checking that out first.


Multiple namespaces
-------------------

There are many different ways to organize your my-restx app,
but here we'll describe one that scales pretty well with larger apps
and maintains a nice level of organization.

my-restx provides a way to use almost the same pattern as Flask's `blueprint`.
...
.. _github repository examples folder: https://github.com/remicastaing/my-restx/tree/master/examples
