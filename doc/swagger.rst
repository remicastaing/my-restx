...
Every my-restx field accepts optional arguments used to document the field:
...
in my-restx with the `@api.vendor` decorator.
...
By default ``my-restx`` provides Swagger UI documentation, served from the root URL of the API.
