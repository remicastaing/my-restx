...
.. warning ::
    ...
    The whole request parser part of my-restx is slated for removal and
...
my-restx's request parsing interface, :mod:`reqparse`,
...
The :mod:`~my_restx.inputs` module provides some common type handling like:
...
See the :mod:`~my_restx.inputs` documentation for full list of available inputs.
