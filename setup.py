...
PYPI_RST_FILTERS = (
    ...
    (
        r":doc:`(.+) <(.*)>`",
        r"`\1 <https://my-restx.readthedocs.io/en/stable\2.html>`_",
    ),
    # replace issues references
    (
        r":issue:`(.+?)`",
        r"`#\1 <https://github.com/remicastaing/my-restx/issues/\1>`_",
    ),
    # replace pr references
    (r":pr:`(.+?)`", r"`#\1 <https://github.com/remicastaing/my-restx/pull/\1>`_"),
    # replace commit references
    (
        r":commit:`(.+?)`",
        r"`#\1 <https://github.com/remicastaing/my-restx/commit/\1>`_",
    ),
...
setup(
    ...
    url="https://github.com/remicastaing/my-restx",
    author="remicastaing Authors",
