...
my-restx is open-source and very open to contributions.
...
1. fork the `official my-restx repository`_
...
You need to install some dependencies to develop on my-restx:
...
You also need to ensure your code is compliant with the my-restx coding standards:
...
.. _official my-restx repository: https://github.com/remicastaing/my-restx
.. _official bugtracker: https://github.com/remicastaing/my-restx/issues
...
from `GitHub Actions <https://github.com/remicastaing/my-restx/actions?query=workflow%3ARelease>`_ when we add a new tag (unless the
tests are failing).
